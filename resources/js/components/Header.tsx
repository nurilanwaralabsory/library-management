...
import { Bell, BookCheck, SearchIcon, X } from 'lucide-react';
    ...
    return (
        <header className="my-10 flex justify-between gap-5">
            ...
            <ul className="flex flex-row items-center gap-4 md:gap-8">
                ...
                <li>
                    <Link
                        href={route('search-books')}
                        className={cn(
                            'flex cursor-pointer items-center text-base capitalize',
                            pathname.url == '/search-books' || pathname.url.startsWith('/search-books') ? 'text-light-200' : 'text-light-100',
                        )}
                    >
                ...
                {auth.user && auth.user.role === 'USER' && (
                    <li>
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent
                                className="w-96 border-none bg-gradient-to-b from-[#232839] to-[#12141D] text-light-100"
                                align="center"
                            >
                    ...
                    <li>
                        <Link href={route('my-profile')}>
                            <div className="flex items-center gap-2">
                                ...
                                <p className="hidden cursor-pointer text-base font-medium text-light-100 capitalize md:block">
